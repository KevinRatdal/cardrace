...
const PlacementIcon = ({ placement }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="32px" viewBox="0 0 24 24" width="32px" fill={getFillColor(placement)}>
      ...
      <rect fill='' height="11" width="6" x="9" y="4" />
      <text fill='#000000' x='9.2' y='13' style={{ font: "bold 10px sans-serif" }} >{placement}</text>
    </svg>
  )
}
